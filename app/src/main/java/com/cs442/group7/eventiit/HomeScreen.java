...
public class HomeScreen extends BaseActivity implements View.OnClickListener, VenueAddressSingleton.Listener, UploadDownloadUtil.GenericListener {
    ...
    private static String url = "http://ec2-54-147-231-178.compute-1.amazonaws.com/PhpProject1/get_featured_events.php";
...
//    private List<EventItemModel> eventList = new ArrayList<>();
    ...
    private static boolean isHawkUser = false;
...
//        SessionManager session = new SessionManager(getApplicationContext());
        ...
        if (!SessionManager.isLoggedIn()) {
            // User is not already logged in. Take him to Home Screen
...
//        top_featured_events.setOnClickListener(this);
        ...
        //top_featured_events.setBackgroundColor(Color.parseColor("#2196F3"));
        top_featured_events.setTextColor(Color.parseColor("#FFFFFF"));
        bottom_events.setTextColor(Color.parseColor("#FFFFFF"));


        /*Typeface font= Typeface.createFromAsset(getAssets(), "Oswald-Light.ttf");
        top_featured_events.setTypeface(font);
*/
...
//                Log.e("TAG","Event Name "+eventParam.get("eventName"));
...
//                Log.e(TAG,is)
    ...
    public void onFetchVenueDetails(VenueAddressSingleton.VenueArrayList<VenueAddressSingleton.VenueAddressObject> venueAddressObjects) {
        this.venueArrayList = venueAddressObjects;
