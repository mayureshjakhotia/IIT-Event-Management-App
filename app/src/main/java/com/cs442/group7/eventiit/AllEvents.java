...
/**
 * Created by mayureshjakhotia on 11/19/16.
 */

public class AllEvents extends BaseActivity implements View.OnClickListener, VenueAddressSingleton.Listener, UploadDownloadUtil.GenericListener {
    ...
    private static String url = "http://ec2-54-147-231-178.compute-1.amazonaws.com/PhpProject1/get_all_records.php";
...
//        top_all_events.setOnClickListener(this);
        ...
        top_all_events.setTextColor(Color.parseColor("#FFFFFF"));
